...
def run_yeast_all_kegg_experiments(prior_weight_func_name='abs'):
    network = nx.read_gpickle(KEGG_GENERATED_FOLDER / 'net.gpickle')

    with open(KEGG_GENERATED_FOLDER / 'all_kegg_annotations.json', 'r') as f:
    ...
    with open(KEGG_GENERATED_FOLDER / 'all_experiments.json', 'r') as f:
