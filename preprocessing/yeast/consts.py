...
RAW_UNIPROT_ANAT_MAPPER_PATH = YEAST_SOURCES_DIR / 'uniprot_mapping.tab'
RAW_YEAST_ANAT_PATH = YEAST_SOURCES_DIR / 'anat_S_cerevisiae.net'
GENERATED_ANAT_NET_PATH = YEAST_GENERATED_SOURCES_DIR / r'anat_net.gpickle'
